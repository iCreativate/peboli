                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      <Link href="/categories/home" className="inline-flex items-center justify-center rounded-xl premium-gradient px-5 py-2.5 text-sm font-semibold text-white">Home & hosting</Link>
